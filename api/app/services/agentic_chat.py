...
NODE_REQUIREMENTS = {
    ...
    "slack_send_dm": {
        "service": "slack",
        "description": "Sends a direct message to a Slack user by email",
        "user_setup": "Connect Slack. The recipient must be in your Slack workspace. Looked up by their Slack-registered email.",
        "data_provided": ["slack_dm_sent"],
        "parameters": {"email": "recipient's Slack email", "message": "text with {{variables}}"},
    },
    "slack_list_channels": {
        "service": "slack",
        "description": "Lists channels in your Slack workspace",
        "user_setup": "Connect Slack.",
        "data_provided": ["slack_channels"],
        "parameters": {},
    },
    "slack_list_users": {
        "service": "slack",
        "description": "Lists users in your Slack workspace",
        "user_setup": "Connect Slack.",
        "data_provided": ["slack_users"],
        "parameters": {},
    },
    "slack_read_history": {
        "service": "slack",
        ...
        "user_setup": "Connect Slack.",
        "data_provided": ["slack_messages"],
        "parameters": {"channel": "#channel-name", "limit": "number of messages"},
    },
    # ========== Calendly ==========
    "calendly_list_events": {
        "service": "calendly",
        "description": "Lists scheduled Calendly events",
        "user_setup": "Connect Calendly.",
        "data_provided": ["calendly_events", "calendly_count"],
        "parameters": {"status": "active/canceled", "count": "max events"},
    },
    "calendly_get_event": {
        "service": "calendly",
        "description": "Gets details of a specific Calendly event",
        "user_setup": "Connect Calendly.",
        "data_provided": ["calendly_event"],
        "parameters": {"event_uuid": "event UUID"},
    },
    "calendly_cancel_event": {
        "service": "calendly",
        "description": "Cancels a Calendly event",
        "user_setup": "Connect Calendly.",
        "data_provided": [],
        "parameters": {"event_uuid": "event UUID", "reason": "cancellation reason"},
    },
    "calendly_create_link": {
        "service": "calendly",
        "description": "Creates a single-use Calendly scheduling link",
        "user_setup": "Connect Calendly. Link is auto-created from your default event type.",
        "data_provided": ["calendly_link", "calendly_link_created"],
        "parameters": {"event_type_uuid": "optional — auto-detected if empty", "max_event_count": "1"},
    },
    # ========== Notion ==========
    "notion_create_page": {
        "service": "notion",
        "description": "Creates a page in a Notion database",
        "user_setup": "Connect Notion. Specify the database ID from your Notion workspace.",
        "data_provided": ["notion_page_id"],
        "parameters": {"database_id": "Notion database ID", "properties": "field values", "content": "page body"},
    },
    "notion_update_page": {
        "service": "notion",
        "description": "Updates a Notion page",
        "user_setup": "Connect Notion.",
        "data_provided": [],
        "parameters": {"page_id": "Notion page ID", "properties": "field values to update"},
    },
    "notion_query_database": {
        "service": "notion",
        "description": "Queries records from a Notion database",
        "user_setup": "Connect Notion.",
        "data_provided": ["notion_results", "notion_count"],
        "parameters": {"database_id": "Notion database ID", "page_size": "max results"},
    },
    "notion_search": {
        "service": "notion",
        "description": "Searches across your Notion workspace",
        "user_setup": "Connect Notion.",
        "data_provided": ["notion_results"],
        "parameters": {"query": "search term", "filter_type": "page/database"},
    },
    # ========== Mailchimp ==========
    "mailchimp_add_subscriber": {
        "service": "mailchimp",
        "description": "Adds a subscriber to a Mailchimp audience",
        "user_setup": "Connect Mailchimp. Specify your audience/list ID.",
        "data_provided": [],
        "parameters": {"list_id": "audience ID", "email": "subscriber email", "status": "subscribed"},
    },
    "mailchimp_add_tags": {
        "service": "mailchimp",
        "description": "Adds tags to a Mailchimp subscriber",
        "user_setup": "Connect Mailchimp.",
        "data_provided": [],
        "parameters": {"list_id": "audience ID", "email": "subscriber email", "tags": "list of tags"},
    },
    "mailchimp_send_campaign": {
        "service": "mailchimp",
        "description": "Creates and sends a Mailchimp email campaign",
        "user_setup": "Connect Mailchimp. Campaign sends immediately and is irreversible.",
        "data_provided": ["campaign_id"],
        "parameters": {"list_id": "audience ID", "subject": "email subject", "html_content": "email HTML"},
    },
    "mailchimp_list_campaigns": {
        "service": "mailchimp",
        "description": "Lists recent Mailchimp campaigns",
        "user_setup": "Connect Mailchimp.",
        "data_provided": ["campaigns"],
        "parameters": {"count": "max campaigns"},
    },
    # ========== Google Drive ==========
    "google_drive_list": {
        "service": "google",
        "description": "Lists files from Google Drive",
        "user_setup": "Connect Google.",
        "data_provided": ["drive_files"],
        "parameters": {},
    },
    "google_calendar_list": {
        "service": "google_calendar",
        "description": "Lists events from Google Calendar",
        "user_setup": "Connect Google Calendar.",
        "data_provided": ["calendar_events"],
        "parameters": {},
    },
    "google_calendar_delete": {
        ...
        "user_setup": "Connect Google Calendar.",
        "data_provided": [],
        "parameters": {"event_id": "calendar event ID"},
    },
    "read_sheet": {
        "service": "google_sheets",
        "description": "Reads data from a Google Spreadsheet",
        "user_setup": "Connect Google Sheets.",
        "data_provided": ["sheet_data"],
        "parameters": {"spreadsheet_id": "spreadsheet ID", "range": "e.g. Sheet1!A1:Z100"},
    },
    "ai_summarize": {
        "service": None,
        "description": "AI generates a summary of the input data",
        "user_setup": "No connection needed — built-in AI.",
        "data_provided": ["ai_summary"],
        "parameters": {"context": "what to summarize"},
    },
    "ai_extract": {
        "service": None,
        "description": "AI extracts structured data from text",
        "user_setup": "No connection needed — built-in AI.",
        "data_provided": ["extracted fields"],
        "parameters": {"fields": "list of fields to extract"},
    },
    "transform": {
        "service": None,
        "description": "Transforms data between steps",
        "user_setup": "No connection needed.",
        "data_provided": [],
        "parameters": {},
    },
    "approval": {
        "service": None,
        "description": "Manual approval gate — pauses workflow until approved",
        "user_setup": "No connection needed. You approve/reject in the dashboard.",
        "data_provided": [],
        "parameters": {},
    },
    "http_request": {
