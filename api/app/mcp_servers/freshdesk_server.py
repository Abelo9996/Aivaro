"""Freshdesk MCP Server — tickets, contacts, agents."""
...
class FreshdeskMCPServer(BaseMCPServer):
    ...
    def _register_tools(self):
        ...
        self._register("freshdesk_get_ticket", "Get details of a Freshdesk ticket.", {
            "type": "object",
        ...
        self._register("freshdesk_add_note", "Add a note to a Freshdesk ticket.", {
            ...
            "properties": {
                ...
                "private": {"type": "boolean", "description": "Private note or public reply", "default": True},
            },
    ...
    async def _create_ticket(self, subject: str, description: str, email: str,
        ...
        return await self.svc.create_ticket(subject, description, email, priority, status)
