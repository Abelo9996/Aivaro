...
class GoogleMCPServer(BaseMCPServer):
    ...
    def _register_tools(self):
        ...
        self._register(
            "gmail_list_messages",
            "List recent Gmail messages. Optionally filter by query.",
            {
                "type": "object",
                "properties": {
    ...
    async def _append_row(self, spreadsheet_name: str, values: dict, sheet_name: str = "Sheet1") -> dict:
        ...
        result = await self.svc.append_row_with_schema(spreadsheet_id, values, sheet_name=sheet_name)
        return {"row_appended": True, "spreadsheet_id": spreadsheet_id, "spreadsheet_name": spreadsheet_name}
